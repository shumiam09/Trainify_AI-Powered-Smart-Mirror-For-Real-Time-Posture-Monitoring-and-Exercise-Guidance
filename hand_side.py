...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            color = (0, 255, 0) if 30 < shoulder_angle < 150 else (0, 0, 255)  # Red if arm is not in front
        ...
        # Display headings and counter
        cv2.putText(image, 'Hand Side Exercise', (20, 30),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
        cv2.putText(image, 'Reps: ' + str(counter_side), (250, 30),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
